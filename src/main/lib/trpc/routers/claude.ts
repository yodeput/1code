          ...
          try {
              ...
              ...(finalCustomConfig && {
                customEnv: {
                  ...
                  ...(finalCustomConfig.model && {
                    ANTHROPIC_MODEL: finalCustomConfig.model,
                  }),
                  ...(finalCustomConfig.defaultOpusModel && {
                    ANTHROPIC_DEFAULT_OPUS_MODEL:
                      finalCustomConfig.defaultOpusModel,
                  }),
                  ...(finalCustomConfig.defaultSonnetModel && {
                    ANTHROPIC_DEFAULT_SONNET_MODEL:
                      finalCustomConfig.defaultSonnetModel,
                  }),
                  ...(finalCustomConfig.defaultHaikuModel && {
                    ANTHROPIC_DEFAULT_HAIKU_MODEL:
                      finalCustomConfig.defaultHaikuModel,
                  }),
                  ...(finalCustomConfig.subagentModel && {
                    CLAUDE_CODE_SUBAGENT_MODEL: finalCustomConfig.subagentModel,
                  }),
                },
              }),
            ...
            try {
              ...
              try {
                ...
                try {
                  const globalSettings = await fs.readFile(
                    homeSettingsPath,
                    "utf-8",
                  );
                ...
                if (finalCustomConfig) {
                  ...
                  if (finalCustomConfig.defaultOpusModel) {
                    profileEnv.ANTHROPIC_DEFAULT_OPUS_MODEL =
                      finalCustomConfig.defaultOpusModel;
                  }
                  if (finalCustomConfig.defaultSonnetModel) {
                    profileEnv.ANTHROPIC_DEFAULT_SONNET_MODEL =
                      finalCustomConfig.defaultSonnetModel;
                  }
                  if (finalCustomConfig.defaultHaikuModel) {
                    profileEnv.ANTHROPIC_DEFAULT_HAIKU_MODEL =
                      finalCustomConfig.defaultHaikuModel;
                  }
                  if (finalCustomConfig.subagentModel) {
                    profileEnv.CLAUDE_CODE_SUBAGENT_MODEL =
                      finalCustomConfig.subagentModel;
                  }
                }
                ...
                console.log(
                  `[claude] Wrote profile settings to ${isolatedSettingsPath}`,
                );
              } catch (settingsErr) {
                console.error(
                  `[claude] Failed to write isolated settings.json:`,
                  settingsErr,
                );
              }
            ...
            if (isUsingOllama) {
              ...
              console.log("[Ollama Debug] SDK Configuration:", {
                ...
                tokenPreview:
                  envRecord.ANTHROPIC_AUTH_TOKEN?.slice(0, 10) + "...",
              });
